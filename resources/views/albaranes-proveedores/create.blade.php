...
@section('title', 'Crear Nuevo Albarán de Proveedor - MoncobraCRM')

@section('header-title')
    <i class="fas fa-plus-circle"></i> Crear Nuevo Albarán de Proveedor
@endsection
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Formulario de Nuevo Albarán</h3>
            </div>
            <form method="POST" action="{{ route('albaranes-proveedores.store') }}">
                @csrf
                <div class="card-body">
                ...
                <div class="card-footer">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> Guardar Albarán
                    </button>
